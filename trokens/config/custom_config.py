...
def add_custom_config(cfg):
    ...
    cfg.FEW_SHOT.POT_ROUTE.CMW_COST_NUM_FAMILIES = 5
    cfg.FEW_SHOT.POT_ROUTE.CMW_COST_HIDDEN_DIM = 128
    cfg.FEW_SHOT.POT_ROUTE.CMW_COST_MIN_RELIABILITY = 0.02
    cfg.FEW_SHOT.POT_ROUTE.CMW_COST_MARGIN_TAU = 0.1
    cfg.FEW_SHOT.POT_ROUTE.QUERY_PARTIAL_ENABLE = False
    cfg.FEW_SHOT.POT_ROUTE.QUERY_PARTIAL_LABEL_CAP = 1.0
    cfg.FEW_SHOT.POT_ROUTE.QUERY_PARTIAL_VIS_CAP = 1.0
